...
<body>
    ...
    <script>
        // Función para obtener los datos de gastos por mes
        function obtenerDatosGastosMes() {
            fetch('get_gasto_mes.php')
                ...
                .then(data => {
                    ...
                    var data = {
                        labels: labels,
                        datasets: [{
                            label: 'Gastos de Petróleo por Mes',
                            data: values,
